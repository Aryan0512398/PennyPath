...
function ExpensesScreen({ params }) {
  ...
  const handleDeleteBudget = async () => {
    const deleteExpenses = await db
      .delete(Expenses)
      .where(eq(Expenses.budgetId, unwrappedParams.id)).returning(); // Delete all expenses associated with the budget
    if (deleteExpenses) {
        ...
        <AlertDialog>
          ...
          <AlertDialogContent>
            ...
            <AlertDialogFooter>
              ...
              <AlertDialogAction className={"cursor-pointer"} onClick={() => handleDeleteBudget()}>
                Continue
              </AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
